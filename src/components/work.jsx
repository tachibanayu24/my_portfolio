...
let cards = [
  {
    image: "/static/images/works/lt_speech.png",
    title: "エンジニア転職LT会で登壇",
    date: "2019/8/7",
    catLg: "other",
    cat: [],
    body:
      "初めてLT会で登壇しました。参加者は80名程度で、10分ほど、自分がどのようにしてSIerからスタートアップに転職したのかについて話しました。スライドを公開してツイートすると、まあまあいいねされました。",
    ref: {
      name: ["Tweet", "スライド"],
      url: [
        "https://twitter.com/tachibanayu24_/status/1159329095848620032",
        "https://www.slideshare.net/ssuserf86341/sierlt"
      ]
    }
  },
  {
    ...
    cat: [],
    body:
      "NTTグループを退職し、5/15よりメタップスグループのpringという会社で働きます。「お金から、なかよく。」を合言葉に、お金コミュニケーションアプリのpringを開発します。",
    ref: {
      name: ["ホームページ"],
  ...
  },
  {
    ...
    cat: [],
    body:
      "月1程度集まってコードを書くサークルを作りました。主に会社の同期が10名ほどいる小規模でゆるいサークルです。仲良く楽しくやっていきます。",
    ref: {
      name: ["LPへ"],
      url: ["https://perches.github.io/"]
    }
  },
  {
    ...
    body:
      "とあるベンチャー企業から業務システム改善の案件を受注しました。初めて個人の仕事で報酬を受け取ります。Spreadsheetで管理している情報を、DBにkintoneを用いたアプリケーションに移行して従来より効率的なシステムの実現を目指すプロジェクトです。提案からリリースまでを一括で請け負います。",
    ref: {
      name: [],
      url: []
    }
  },
  {
    ...
    cat: ["JS", "CSS"],
    body:
      "現在仕事で社内研修システムの開発のチームリーダーをやっており、そこで使おうと思って作ってみたものです。初めて人に使ってもらうことを意識して、READMEなど丁寧に書いてみました。コピペですぐにWebページに導入できます。",
    ref: {
      name: ["GitHub", "Qiita"],
      url: [
        "https://tachibanayu24.github.io/EasyGantt.js/",
        "https://qiita.com/tachibanayu24/items/28b4ed4e10263335d0f4"
      ]
    }
  },
  {
    ...
    body:
      "このページです。はじめてのReactです。自身の成果を振り返ったり、モチベーションを保ったりするのに良さそうなので開発しました。フロントエンドの知識をつけたかったのでReactにしました。お気に入りポイントのappBarは、私のMacbookのターミナルのプロンプトを再現しています。",
    ref: {
      name: ["サイトへ", "", "GitHub"],
  ...
  },
  {
    ...
    ref: {
      name: ["Qiita", "", ""],
      url: [
        "https://qiita.com/tachibanayu24/items/282e09ccfe6089bb0476",
        "",
        ""
      ]
    }
  },
  {
    ...
    cat: ["Lambda", "JS", "VUI"],
    body:
      "はじめてのAlexaSkill開発。「Alexa。みんなのルーレットで都道府県やって。」でランダムに都道府県を返します。国名や料理名にも対応しています。ダーツの旅をたまにやるので開発してみました。公開申請の準備中です。",
    ref: {
      name: ["準備中", "紹介ツイート", ""],
      url: [
        "#",
        "https://twitter.com/tachibanayu24/status/1046381193506091008",
        ""
      ]
    }
  },
  {
    ...
    date: "2018/9/17",
    body:
      "ハッカソン#2 in 新宿。初めてDjangoを使いました。内に秘められがちな暗黙知をMarkdown記法によって共有できるサービスです。要するにQiitaのエロ版です。" +
    ...
    ref: {
      ...
      url: [
        ...
        "https://github.com/tachibanayu24/py_slash_tinps"
      ]
    }
  },
  {
    ...
    body:
      "ハッカソン#2の前に、#1でハマったデプロイ手順を勉強する意味も込めてQiitaに記事を投稿しました。初めて読まれることを意識して書きました。",
    ref: {
      name: ["Qiita", "", ""],
      url: [
  ...
  },
  {
    ...
    date: "2018/8/23",
    body:
      "ハッカソン#1 in 大阪。初めて独自ドメインで公開したWebアプリです(現在は停止中)。TwitterAPIでユーザ登録し、一日一回就業後にスタンプを押します。" +
      "スタンプ数に応じてアプリ内の労働環境が変化し、最終的に会社が爆発します。会社が嫌いなわけではなく「もっとエッジ効かせたい」を繰り返したらこうなってしまいました。",
    ref: {
      name: ["停止中", "紹介ツイート", "GitHub"],
      url: [
        "",
        "https://twitter.com/tachibanayu24/status/1032619847216070656",
        "https://github.com/tachibanayu24/incrude"
      ]
    }
  },
  {
    ...
    cat: [],
    body:
      "100日間コーディングをしてTwitterで報告するという、マラソンのような活動を始めます。最初80日はインプットしつつ月1ペースでなにか作り、最後20日くらいで自分のWebサービスを作りたい。",
    ref: {
      name: ["ツイート一覧", "", ""],
      url: [
        "https://twitter.com/search?f=tweets&q=from%3Atachibanayu24%20%23100DaysOfCode",
        "",
        ""
      ]
    }
